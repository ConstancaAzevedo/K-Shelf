...
namespace K_Shelf.Data.Migrations
{
    ...
    [Migration("20260627002104_MakeArtistaFieldsRequired")]
    partial class MakeArtistaFieldsRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("K_Shelf.Models.Musica", b =>
                {
                    ...
                    b.Property<string>("PreviewAudioUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("K_Shelf.Models.Photocard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("K_Shelf.Models.UtilizadorPhotocard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PhotocardId");

                    b.HasIndex("UtilizadorId");

                    b.ToTable("UtilizadorPhotocards");
                });
            ...
            modelBuilder.Entity("K_Shelf.Models.UtilizadorPhotocard", b =>
                {
                    b.HasOne("K_Shelf.Models.Photocard", "Photocard")
                        .WithMany("UtilizadorPhotocards")
            ...
            modelBuilder.Entity("K_Shelf.Models.Photocard", b =>
                {
                    b.Navigation("UtilizadorPhotocards");
                });
